...
| uv | exact version and official release archive pinned in `mise.lock` | <https://github.com/astral-sh/uv> | Dual-licensed Apache-2.0 OR MIT. Both upstream license choices are preserved. | `components/uv/` |
