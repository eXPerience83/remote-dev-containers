...
require_text "$ROOT/scripts/copy-runtime-notices.sh" 'licenses/LICENSE.cpython.txt'
require_text "$ROOT/scripts/remote-dev-notices.sh" 'runtime/python/licenses/LICENSE.cpython.txt'
