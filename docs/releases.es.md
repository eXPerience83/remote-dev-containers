...
8. El launcher base no tiene montajes de agentes ni socket Docker/Podman; la autenticación opcional del launcher usa su propia contraseña de configuración y continúa sin mounts.
...
15. Las credenciales web de Codex y Antigravity se configuran de forma independiente y cada una se valida únicamente contra su endpoint bajo #69.
