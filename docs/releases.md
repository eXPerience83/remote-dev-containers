...
8. The base launcher has no agent mounts and no Docker/Podman socket; optional launcher authentication uses its own configuration-backed password and remains mount-free.
...
15. Codex and Antigravity browser credentials are configuration-backed, distinct and validated against their own endpoints under #69.
