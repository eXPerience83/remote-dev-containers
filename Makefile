...
validate:
	...
	python3 -m py_compile scripts/remote-dev-launcher.py scripts/preflight-data-layout.py scripts/test_single_stack_compose.py scripts/test_canonical_data_layout.py scripts/test_preflight_data_layout.py
